...
@section('content')
    ...
    <form class="card card-md" action="{{ route('auth.recoveryPassword') }}" method="post" autocomplete="off">
        @csrf
        @method('PUT')
        <input type="hidden" name="id" value="{{ $user->id }}" />
        
        <div class="card-body">
            <h2 class="card-title text-center mb-4">Introduzca una contraseña para recuperar su cuenta</h2>
