                  ...
                  <table class="table card-table table-vcenter text-nowrap datatable">
                    ...
                    @foreach ($tests as $test)
                      <tr>
                        ...
                        <td>{{ $test['date'] }}</td>
                        <td>{{ $test['time'] }}</td>
                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#clinic">{{ $test['clinic']['name'] }}</a></td>
                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#patient">{{ $test['patient']['name'] }}</a></td>
                        <td>
                          @if ($test['status'] == true)
